...
def main():
    ...
    for i in doc:
        ...
        sql_update = f"update tbt_gedi_datas set download=0,is_download_from_cloud=true,upload_date='{str(_date)}',upload_time='{str(_date)}',created_at='{str(_date)}',updated_at='{str(_date)}' where id='{i[0]}'"
